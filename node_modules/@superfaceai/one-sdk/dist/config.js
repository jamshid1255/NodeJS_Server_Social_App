...
exports.Config = exports.DEFAULT_BOUND_PROVIDER_TIMEOUT = exports.DEFAULT_SANDBOX_TIMEOUT = exports.DEFAULT_CACHE_PATH = exports.DEFAULT_METRIC_DEBOUNCE_TIME = exports.DEFAULT_SUPERFACE_PATH = exports.DEFAULT_API_URL = void 0;
...
function getBoundCacheTimeout() {
    var envValue = process.env[BOUND_PROVIDER_CACHE_TIMEOUT];
    if (envValue === undefined) {
        return exports.DEFAULT_BOUND_PROVIDER_TIMEOUT;
    }
    try {
        ...
        configDebug("Invalid value: " + envValue + " for " + BOUND_PROVIDER_CACHE_TIMEOUT + ", expected positive number");
        return exports.DEFAULT_BOUND_PROVIDER_TIMEOUT;
    }
}
...
function getSandboxTimeout() {
    var envValue = process.env[SANDBOX_TIMEOUT_ENV_NAME];
    if (envValue === undefined) {
        return exports.DEFAULT_SANDBOX_TIMEOUT;
    }
    try {
        var result = parseInt(envValue);
        if (result <= 0) {
        ...
        configDebug("Invalid value: " + envValue + " for " + SANDBOX_TIMEOUT_ENV_NAME + ", expected positive number");
        return exports.DEFAULT_SANDBOX_TIMEOUT;
    }
}
