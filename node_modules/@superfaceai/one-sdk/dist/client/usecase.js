...
var UseCaseBase = /** @class */ (function () {
    ...
    UseCaseBase.prototype.bind = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var hookRouter, providerConfig, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        hookRouter = this.profile.client.hookContext[this.profile.configuration.id + "/" + this.name].router;
                        return [4 /*yield*/, this.resolveProviderConfiguration(hookRouter.getCurrentProvider(), options)];
                    case 1:
    ...
    UseCaseBase.prototype.resolveProviderConfiguration = function (currentProvider, options) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
    ...
    UseCaseBase.prototype.getProviderConfiguration = function (currentProvider) {
        return __awaiter(this, void 0, void 0, function () {
            var provider, provider;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(currentProvider === undefined)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.profile.client.getProviderForProfile(this.profile.configuration.id)];
                    case 1:
                        provider = _a.sent();
                        return [2 /*return*/, provider.configuration];
                    case 2:
                        if (!(typeof currentProvider === 'string')) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.profile.client.getProvider(currentProvider)];
                    case 3:
                        provider = _a.sent();
                        return [2 /*return*/, provider.configuration];
                    case 4: return [2 /*return*/, currentProvider.configuration];
                }
            });
        });
    };
    ...
    UseCaseBase.prototype.instantiateFailurePolicy = function (provider) {
        ...
        if (retryPolicyConfig.kind === ast_1.OnFail.CIRCUIT_BREAKER) {
            var backoff = new backoff_1.ExponentialBackoff(backoff_1.Backoff.DEFAULT_INITIAL, backoff_1.ExponentialBackoff.DEFAULT_BASE);
            if (((_d = retryPolicyConfig.backoff) === null || _d === void 0 ? void 0 : _d.kind) &&
                ...
                backoff = new backoff_1.ExponentialBackoff((_f = retryPolicyConfig.backoff.start) !== null && _f !== void 0 ? _f : backoff_1.Backoff.DEFAULT_INITIAL, (_g = retryPolicyConfig.backoff.factor) !== null && _g !== void 0 ? _g : backoff_1.ExponentialBackoff.DEFAULT_BASE);
            }
            policy = new policies_1.CircuitBreakerPolicy(usecaseInfo, 
            //TODO are these defauts ok?
            (_h = retryPolicyConfig.maxContiguousRetries) !== null && _h !== void 0 ? _h : policies_1.RetryPolicy.DEFAULT_MAX_CONTIGUOUS_RETRIES, (_j = retryPolicyConfig.openTime) !== null && _j !== void 0 ? _j : policies_1.CircuitBreakerPolicy.DEFAULT_OPEN_TIME, (_k = retryPolicyConfig.requestTimeout) !== null && _k !== void 0 ? _k : policies_1.RetryPolicy.DEFAULT_REQUEST_TIMEOUT, backoff);
        }
        else if (retryPolicyConfig.kind === ast_1.OnFail.SIMPLE) {
            policy = new policies_1.RetryPolicy(usecaseInfo, (_l = retryPolicyConfig.maxContiguousRetries) !== null && _l !== void 0 ? _l : policies_1.RetryPolicy.DEFAULT_MAX_CONTIGUOUS_RETRIES, (_m = retryPolicyConfig.requestTimeout) !== null && _m !== void 0 ? _m : policies_1.RetryPolicy.DEFAULT_REQUEST_TIMEOUT, new backoff_1.ConstantBackoff(0));
        }
