...
var SuperfaceClientBase = /** @class */ (function (_super) {
    ...
    function SuperfaceClientBase(options) {
        ...
        _this.boundCache = {};
        _this.hookContext = {};
        _this.superJson = resolveSuperJson(options === null || options === void 0 ? void 0 : options.superJson);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.rebind(profileConfig, providerConfig)];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
                        if (bound.expiresAt < now) {
                            void Promise.resolve().then(function () {
                                return _this.rebind(profileConfig, providerConfig);
                            });
                        }
                        _a.label = 3;
                    case 3: return [2 /*return*/, this.boundCache[cacheKey].profileProvider];
                }
            });
        });
    };
    SuperfaceClientBase.prototype.rebind = function (profileConfig, providerConfig) {
        return __awaiter(this, void 0, void 0, function () {
            var cacheKey, now, profileProvider, boundProfileProvider;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        cacheKey = profileConfig.cacheKey + providerConfig.cacheKey;
                    ...
                    case 1:
                        ...
                        this.boundCache[cacheKey] = {
                            ...
                            expiresAt: now + config_1.Config.instance().superfaceCacheTimeout,
                        };
                        return [2 /*return*/];
                }
            });
...
var resolveSuperJson = function (superJson) {
    if (!superJson) {
        var cacheKey = config_1.Config.instance().superfacePath;
        if (SUPER_CACHE[cacheKey] === undefined) {
            SUPER_CACHE[cacheKey] = internal_1.SuperJson.loadSync(cacheKey).unwrap();
        }
        return SUPER_CACHE[cacheKey];
    }
    if (superJson instanceof internal_1.SuperJson) {
        return superJson;
    }
    return new internal_1.SuperJson(superJson);
};
