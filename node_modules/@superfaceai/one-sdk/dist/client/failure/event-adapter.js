...
var fetch_errors_1 = require("../../lib/fetch.errors");
var debug = debug_1.default('superface:failover');
var debugSensitive = debug_1.default('superface:failover:sensitive');
...
function registerHooks(hookContext, events) {
    var _this = this;
    ...
    events.on('pre-bind-and-perform', { priority: 1 }, function (context, args) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            ...
            performContext = hookContext[context.profile + "/" + context.usecase];
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (context.provider === undefined) {
                        throw new errors_1.UnexpectedError('Invalid event context');
                    }
                    performContext = hookContext[context.profile + "/" + context.usecase];
                    // if there is no configured context: ignore the event
                    if (performContext === undefined) {
                ...
                case 4:
                    ...
                    if (error instanceof errors_1.SDKBindError) {
                ...
                case 6:
                    ...
                    switch (action.kind) {
                        ...
                        case 'recache':
                            throw new errors_1.UnexpectedError('Not Implemented'); // TODO: how to recache?
                        case 'full-abort':
...
function registerNetworkHooks(hookContext, events) {
    var _this = this;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [3 /*break*/, 5];
                case 2: return [4 /*yield*/, lib_1.sleep(resolution.backoff)];
                case 3:
                    _b.sent();
                    if (resolution.timeout > 0) {
                        newArgs = lib_1.clone(args);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    if (fetch_errors_1.isCrossFetchError(error)) {
