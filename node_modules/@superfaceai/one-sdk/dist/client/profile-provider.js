...
var ProfileProvider = /** @class */ (function () {
    ...
    ProfileProvider.prototype.bind = function (configuration) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var profileAst, profileId, resolvedProviderInfo, providerInfo, providerName, securityValues, thisProviderName, resolvedMapAst, mapAst, mapVariant, mapRevision, fetchResponse, version, mapId, mapSource, securityConfiguration;
                ...
                switch (_d.label) {
                    ...
                    case 11:
                        ...
                        return [2 /*return*/, new BoundProfileProvider(profileAst, mapAst, providerInfo, {
                                ...
                                profileProviderSettings: (_b = this.superJson.normalized.profiles[profileId]) === null || _b === void 0 ? void 0 : _b.providers[providerInfo.name],
                                security: securityConfiguration,
                                parameters: this.resolveIntegrationParameters(providerInfo, (_c = this.superJson.normalized.providers[providerInfo.name]) === null || _c === void 0 ? void 0 : _c.parameters),
                            }, this.events)];
                }
            });
        });
    ...
    ProfileProvider.prototype.cacheProviderInfo = function (providerName) {
        return __awaiter(this, void 0, void 0, function () {
            var errors, providerCachePath, _a, error_1, providerJsonFile, error_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        errors = [];
                    ...
                    case 4:
                        error_1 = _b.sent();
                        profileProviderDebug("Failed to fetch provider.json for " + providerName + ": %O", error_1);
                        errors.push(error_1);
                        return [3 /*break*/, 5];
                    case 5:
                        if (!(this.providerJson === undefined)) return [3 /*break*/, 9];
                    ...
                    case 6:
                        _b.trys.push([6, 8, , 9]);
                        return [4 /*yield*/, fs_1.promises.readFile(providerCachePath, 'utf8')];
                    case 7:
                        providerJsonFile = _b.sent();
                        this.providerJson = ast_1.assertProviderJson(JSON.parse(providerJsonFile));
                        return [3 /*break*/, 9];
                    case 8:
                        error_2 = _b.sent();
                        profileProviderDebug("Failed to read cached provider.json for " + providerName + ": %O", error_2);
                        errors.push(error_2);
                        return [3 /*break*/, 9];
                    case 9:
                        if (this.providerJson === undefined) {
                            throw new internal_1.UnexpectedError('Failed to fetch provider.json or load it from cache.', errors);
                        }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, fs_1.promises.writeFile(providerCachePath, JSON.stringify(providerJson, undefined, 2))];
                    case 3:
                        _a.sent();
                        return [3 /*break*/, 5];
                    case 4:
                        error_3 = _a.sent();
                        profileProviderDebug("Failed to cache provider.json for " + providerJson.name + ": %O", error_3);
                        return [3 /*break*/, 5];
