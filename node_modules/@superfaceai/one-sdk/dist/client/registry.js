    ...
    return __awaiter(this, void 0, void 0, function () {
        function assertProperties(obj) {
            if (typeof obj !== 'object' ||
                ...
                throw errors_helpers_1.unknownProviderInfoError({
        ...
        var fetchInstance, http, sdkToken, _a, body, statusCode;
...
function parseBindResponse(request, response) {
    ...
    function assertProperties(obj) {
        if (typeof obj !== 'object' ||
            ...
            throw errors_helpers_1.unknownBindResponseError(__assign(__assign({}, request), { statusCode: response.statusCode, body: response.body }));
        }
    }
    if (response.statusCode !== 200) {
        if (isErrorBody(response.body)) {
            throw errors_helpers_1.bindResponseError(__assign(__assign({}, request), { statusCode: response.statusCode, title: response.body.title, detail: response.body.detail }));
        }
        throw errors_helpers_1.unknownBindResponseError(__assign(__assign({}, request), { statusCode: response.statusCode, body: response.body }));
    }
    ...
    try {
        ...
        throw errors_helpers_1.invalidProviderResponseError(error);
    }
    return {
        provider: provider,
        mapAst: mapAst,
...
function fetchBind(request) {
    return __awaiter(this, void 0, void 0, function () {
        var fetchInstance, http, sdkToken, fetchResponse;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, parseBindResponse(request, fetchResponse)];
            }
        });
    });
}
