...
var debug = debug_1.default('superface:map-interpreter');
function assertUnreachable(node) {
    throw new errors_1.UnexpectedError("Invalid Node kind: " + node.kind);
}
...
var MapInterpreter = /** @class */ (function () {
    function MapInterpreter(parameters, _a) {
        var fetchInstance = _a.fetchInstance, externalHandler = _a.externalHandler;
        this.parameters = parameters;
        this.operations = {};
        this.stack = [];
        this.http = new http_1.HttpClient(fetchInstance);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, lib_1.ok(result.result)];
                    case 3:
                        e_1 = _a.sent();
                        return [2 /*return*/, lib_1.err(e_1)];
    ...
    MapInterpreter.prototype.visit = function (node) {
        debug('Visiting node:', node.kind, node.location
    ...
    MapInterpreter.prototype.visitHttpCallStatementNode = function (node) {
        var _a, _b, _c, _d;
        return __awaiter(this, void 0, void 0, function () {
            var serviceUrl, request, _e, responseHandlers, accept, accepts_1, retry, response, responseHandlers_1, responseHandlers_1_1, _f, handler, match, e_2_1, action;
            var e_2, _g;
            var _this = this;
                ...
                switch (_h.label) {
                    case 0:
                        ...
                        if (serviceUrl === undefined) {
                            throw new errors_1.UnexpectedError('Base url for a service not provided for HTTP call.');
                        }
                        _e = node.request;
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.http.request(node.url, {
                                ...
                                contentType: (_a = request === null || request === void 0 ? void 0 : request.contentType) !== null && _a !== void 0 ? _a : 'application/json',
                                accept: accept,
                                baseUrl: serviceUrl,
                    ...
                    case 6:
                        ...
                        _f = __read(responseHandlers_1_1.value, 1), handler = _f[0];
                    ...
                    case 11:
                        try {
                            if (responseHandlers_1_1 && !responseHandlers_1_1.done && (_g = responseHandlers_1.return)) _g.call(responseHandlers_1);
                        }
                        finally { if (e_2) throw e_2.error; }
                        return [7 /*endfinally*/];
                    case 12:
                        if (!(this.externalHandler.unhandledHttp !== undefined)) return [3 /*break*/, 14];
                        return [4 /*yield*/, ((_c = (_b = this.externalHandler).unhandledHttp) === null || _c === void 0 ? void 0 : _c.call(_b, this.ast, node, response))];
                    case 13:
                        action = (_d = (_h.sent())) !== null && _d !== void 0 ? _d : 'continue';
                        if (action !== 'retry') {
                            retry = false;
                        }
                        return [3 /*break*/, 15];
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        this.addVariableToStack({
                            body: variables_1.castToVariables(response.body),
                            headers: variables_1.castToVariables(response.headers),
    ...
    MapInterpreter.prototype.visitJessieExpressionNode = function (node) {
        try {
            var result = sandbox_1.evalScript(node.expression, this.variables);
            return variables_1.castToVariables(result);
        }
        catch (e) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 5:
                        outcome = _d.sent();
                        if (outcome === null || outcome === void 0 ? void 0 : outcome.error) {
                            stackTop = this.stackTop();
                            if (stackTop.type === 'map') {
                                error = void 0;
                                if (stackTop.context[stackTop.context.length - 1] === 'http') {
                                    statusCode = this.stackTop('map').variables.statusCode;
                                    error = new map_interpreter_errors_1.MappedHTTPError('Expected HTTP error', typeof statusCode === 'number' ? statusCode : undefined, { node: statement, ast: this.ast }, outcome === null || outcome === void 0 ? void 0 : outcome.result);
                                }
                                else {
                            ...
                            this.stackTop().result = (_a = outcome === null || outcome === void 0 ? void 0 : outcome.result) !== null && _a !== void 0 ? _a : this.stackTop().result;
                        }
                        debug('Setting result: %O', this.stackTop());
                        if (outcome === null || outcome === void 0 ? void 0 : outcome.terminateFlow) {
                            this.stackTop().terminate = true;
                            return [2 /*return*/];
                        }
                        return [3 /*break*/, 6];
    ...
    MapInterpreter.prototype.visitMapHeaderNode = function (_node) {
        throw new errors_1.UnexpectedError('Method not implemented.');
    };
    ...
    MapInterpreter.prototype.addVariableToStack = function (variables) {
        this.stackTop().variables = variables_1.mergeVariables(this.stackTop().variables, variables);
    ...
    MapInterpreter.prototype.stackTop = function (assertType) {
        if (this.stack.length === 0) {
            throw new errors_1.UnexpectedError('Trying to get variables out of scope!');
        }
        var stack = this.stack[this.stack.length - 1];
        if (assertType !== undefined && stack.type !== assertType) {
            throw new errors_1.UnexpectedError("Trying to get '" + assertType + "', but got " + stack.type + "!");
        }
        return stack;
    };
    MapInterpreter.prototype.visitCallCommon = function (node) {
        return __awaiter(this, void 0, void 0, function () {
            var operation, args, _a, _b, assignment, _c, _d, e_8_1, _e, data, error;
            var e_8, _f;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 1:
                        ...
                        _a = __values(node.arguments), _b = _a.next();
                        _g.label = 2;
                    case 2:
                        if (!!_b.done) return [3 /*break*/, 5];
                        assignment = _b.value;
                        ...
                        return [4 /*yield*/, this.visit(assignment)];
                    case 3:
                        args = _c.apply(void 0, _d.concat([_g.sent()]));
                        _g.label = 4;
                    case 4:
                        _b = _a.next();
                        return [3 /*break*/, 2];
                    ...
                    case 9:
                        _g.sent();
                        _e = this.stackTop('operation'), data = _e.result, error = _e.error;
                        this.popStack();
    ...
    MapInterpreter.prototype.iterate = function (node, processResult) {
        return __awaiter(this, void 0, void 0, function () {
            var iterationParams, _a, _b, variable, condition, result, e_9_1;
            var e_9, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        ...
                        _a = __values(iterationParams.iterable), _b = _a.next();
                        _d.label = 3;
                    case 3:
                        ...
                        if (!node.condition) return [3 /*break*/, 5];
                        return [4 /*yield*/, this.visit(node.condition)];
                    case 4:
                        condition = _d.sent();
                        if (condition === false) {
                        ...
                        _d.label = 5;
                    case 5: return [4 /*yield*/, this.visitCallCommon(node)];
                    case 6:
                        result = _d.sent();
