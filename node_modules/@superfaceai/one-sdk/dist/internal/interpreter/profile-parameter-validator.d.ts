...
import { ProfileParameterError, ValidationError } from './profile-parameter-validator.errors';
...
export declare class ProfileParameterValidator implements ProfileVisitor {
    ...
    constructor(ast: ProfileASTNode);
    validate(input: unknown, kind: ProfileParameterKind, usecase: string): Result<undefined, ProfileParameterError>;
