...
import { AuthCache, HttpRequest, ISecurityHandler, RequestParameters } from './security';
/**
...
export declare const fetchFilter: (fetchInstance: FetchInstance & AuthCache) => FilterWithRequest;
export declare const authenticateFilter: (handler?: ISecurityHandler) => Filter;
export declare const handleResponseFilter: (fetchInstance: FetchInstance & AuthCache, handler?: ISecurityHandler) => FilterWithResponse;
