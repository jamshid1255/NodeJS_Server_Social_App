...
import { AuthCache, HttpRequest, SecurityConfiguration } from './security';
...
export declare function fetchRequest(fetchInstance: FetchInstance, request: HttpRequest): Promise<HttpResponse>;
export declare class HttpClient {
    private fetchInstance;
    constructor(fetchInstance: FetchInstance & AuthCache);
