...
var debug = debug_1.default('superface:http:security:http-handler');
var HttpHandler = /** @class */ (function () {
    function HttpHandler(configuration) {
        var _this = this;
            ...
            return __generator(this, function (_a) {
                ...
                switch (this.configuration.scheme) {
                    case ast_1.HttpScheme.BASIC:
                        ...
                        headers[security_1.DEFAULT_AUTHORIZATION_HEADER_NAME] = applyBasicAuth(this.configuration);
                        break;
                    case ast_1.HttpScheme.BEARER:
                        debug('Setting bearer http auhentization');
                        headers[security_1.DEFAULT_AUTHORIZATION_HEADER_NAME] = applyBearerToken(this.configuration);
                        break;
                }
...
function applyBasicAuth(configuration) {
    return ('Basic ' +
        Buffer.from(configuration.username + ":" + configuration.password).toString('base64'));
}
function applyBearerToken(configuration) {
