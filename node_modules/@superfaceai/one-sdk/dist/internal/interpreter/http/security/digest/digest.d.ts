...
import { AuthCache, AuthenticateRequestAsync, ISecurityHandler } from '../interfaces';
/**
...
export declare class DigestHandler implements ISecurityHandler {
    ...
    private nc;
    constructor(configuration: DigestSecurityScheme & DigestSecurityValues, fetchInstance: FetchInstance & AuthCache);
 ...
 * @returns hashed data
 */
export declare function computeHash(algorithm: DigestAlgorithm, data: string): string;
export {};
