...
var debug = debug_1.default('superface:http:api-key-handler');
var ApiKeyHandler = /** @class */ (function () {
    function ApiKeyHandler(configuration) {
        var _this = this;
        ...
        this.authenticate = function (parameters) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                name = this.configuration.name || security_1.DEFAULT_AUTHORIZATION_HEADER_NAME;
                switch (this.configuration.in) {
                    ...
                    case ast_1.ApiKeyPlacement.BODY:
                        ...
                        body = applyApiKeyAuthInBody(body || {}, name.startsWith('/') ? name.slice(1).split('/') : [name], this.configuration.apikey);
                        break;
