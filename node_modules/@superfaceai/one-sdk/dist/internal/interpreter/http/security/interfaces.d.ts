import { ApiKeySecurityScheme, ApiKeySecurityValues, BasicAuthSecurityScheme, BasicAuthSecurityValues, BearerTokenSecurityScheme, BearerTokenSecurityValues, DigestSecurityScheme, DigestSecurityValues, HttpSecurityRequirement } from '@superfaceai/ast';
import { NonPrimitive, Variables } from '../../variables';
import { HttpResponse } from '../http';
import { FetchParameters } from '../interfaces';
export declare const DEFAULT_AUTHORIZATION_HEADER_NAME = "Authorization";
export declare type AuthCache = {
    digest?: string;
};
/**
 ...
 */
export declare type AuthenticateRequestAsync = (parameters: RequestParameters) => Promise<RequestParameters>;
/**
 ...
 */
export declare type HandleResponseAsync = (response: HttpResponse, resourceRequestParameters: RequestParameters) => Promise<HttpRequest | undefined> | undefined;
/**
...
export declare type HttpRequest = FetchParameters & {
    url: string;
};
