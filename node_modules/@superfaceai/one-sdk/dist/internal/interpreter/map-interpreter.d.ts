import { AssignmentNode, CallStatementNode, ConditionAtomNode, HttpCallStatementNode, HttpRequestNode, HttpResponseHandlerNode, HttpSecurityRequirement, InlineCallNode, IterationAtomNode, JessieExpressionNode, LiteralNode, MapASTNode, MapAstVisitor, MapDefinitionNode, MapDocumentNode, MapHeaderNode, ObjectLiteralNode, OperationDefinitionNode, OutcomeStatementNode, PrimitiveLiteralNode, SetStatementNode } from '@superfaceai/ast';
import { Result } from '../../lib';
import { IServiceSelector } from '../../lib/services';
import { MapInterpreterExternalHandler } from './external-handler';
import { AuthCache, HttpResponse, SecurityConfiguration } from './http';
import { FetchInstance } from './http/interfaces';
import { MapInterpreterError } from './map-interpreter.errors';
import { NonPrimitive, Primitive, Variables } from './variables';
...
export declare class MapInterpreter<TInput extends NonPrimitive | undefined> implements MapAstVisitor {
    ...
    constructor(parameters: MapParameters<TInput>, { fetchInstance, externalHandler, }: {
