...
export declare function invalidProviderResponseError(error: unknown): SDKExecutionError;
export declare function bindResponseError({ statusCode, profileId, provider, title, detail, mapVariant, mapRevision, }: {
    statusCode: number;
    profileId: string;
    provider?: string;
    title?: string;
...
export declare function unknownBindResponseError({ statusCode, profileId, body, provider, mapVariant, mapRevision, }: {
    statusCode: number;
    profileId: string;
    body: unknown;
    provider?: string;
