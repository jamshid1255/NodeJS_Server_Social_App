...
export declare type TypeName = PrimitiveTypeNameNode | ModelTypeNameNode;
/**
...
export interface NonNullDefinitionNode extends ProfileASTNodeBase {
    ...
    type: TypeName | ObjectDefinitionNode | EnumDefinitionNode | ListDefinitionNode;
}
/**
 ...
 */
export interface FieldDefinitionNode extends ProfileASTNodeBase, DocumentedNode {
 ...
 */
export interface NamedFieldDefinitionNode extends ProfileASTNodeBase, DocumentedNode {
 ...
 */
export interface NamedModelDefinitionNode extends ProfileASTNodeBase, DocumentedNode {
...
```
*/
export interface UseCaseDefinitionNode extends ProfileASTNodeBase, DocumentedNode {
