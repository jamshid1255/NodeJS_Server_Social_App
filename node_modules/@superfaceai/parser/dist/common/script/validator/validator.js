...
function constructDebugVisualTree(root) {
    ...
    function nodeVisitor(node) {
        ...
        debugTree += "".concat(treeIndent, "NODE kind: ").concat(ts.SyntaxKind[node.kind], ", full: [").concat(node.pos, ", ").concat(node.end, "], text: [").concat(node.getStart(), ", ").concat(node.getEnd(), "] - \"").concat(nodeCode, "\"");
...
function validateScript(sourceNode, sourceText) {
    var diagnostics = [];
    function nodeVisitor(node) {
        var e_2, _a;
        var _b, _c, _d;
        ...
        try {
            for (var rules_2 = __values(rules), rules_2_1 = rules_2.next(); !rules_2_1.done; rules_2_1 = rules_2.next()) {
                ...
                if ((_d = (_c = rule.predicate) === null || _c === void 0 ? void 0 : _c.call(rule, node)) !== null && _d !== void 0 ? _d : true) {
                    anyRuleBroken = true;
                    diagnostics.push({
                        detail: "".concat(ts.SyntaxKind[node.kind], " construct is not supported"),
