...
function documentedNode(rule) {
    return rule_1.SyntaxRule.followedBy(rule_1.SyntaxRule.optional(rule_1.SyntaxRule.string()), rule).map(function (_a) {
        var _b = __read(_a, 2), maybeDoc = _b[0], result = _b[1];
        var doc = (0, util_1.extractDocumentation)(maybeDoc === null || maybeDoc === void 0 ? void 0 : maybeDoc.data.string);
...
exports.ASSIGNMENT_PATH_KEY = rule_1.SyntaxRule.followedBy(ASSIGNMENT_KEY, rule_1.SyntaxRule.optionalRepeat(rule_1.SyntaxRule.followedBy(rule_1.SyntaxRule.operator('.'), ASSIGNMENT_KEY))).map(function (_a) {
...
function TERMINATOR_TOKEN_FACTORY() {
    ...
    return rule_1.SyntaxRule.or.apply(rule_1.SyntaxRule, __spreadArray([], __read(rules), false));
}
...
function expectTerminated(rule) {
    ...
    return rule
        .lookahead(TERMINATOR_TOKEN_FACTORY.apply(void 0, __spreadArray([], __read(terminators), false)))
        .skip(rule_1.SyntaxRule.optional(TERMINATOR_TOKEN_FACTORY.apply(void 0, __spreadArray([], __read(terminators.filter(function (ter) { return ter === ',' || ter === ';'; })), false))));
}
