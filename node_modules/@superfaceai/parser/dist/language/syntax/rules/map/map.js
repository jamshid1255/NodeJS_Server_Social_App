...
function RHS_EXPRESSION_FACTORY(nonJessieAttempt) {
    ...
    return nonJessieAttempt
        .lookahead(common_1.TERMINATOR_TOKEN_FACTORY.apply(void 0, __spreadArray([], __read(terminators), false)))
        .or(common_2.JESSIE_EXPRESSION_FACTORY.apply(void 0, __spreadArray([], __read(terminators), false)))
        .skip(rule_1.SyntaxRule.optional(common_1.TERMINATOR_TOKEN_FACTORY.apply(void 0, __spreadArray([], __read(terminators.filter(function (ter) { return ter === ',' || ter === ';'; })), false))));
}
...
var CALL_STATEMENT_HEAD = rule_1.SyntaxRule.followedBy(rule_1.SyntaxRule.identifier('call'), rule_1.SyntaxRule.optional(common_2.ITERATION_ATOM), rule_1.SyntaxRule.identifier(), rule_1.SyntaxRule.separator('('), rule_1.SyntaxRule.optionalRepeat(exports.ARGUMENT_LIST_ASSIGNMENT), rule_1.SyntaxRule.separator(')'), rule_1.SyntaxRule.optional(common_2.CONDITION_ATOM)).map(function (_a) {
    ...
    return {
        ...
        location: (0, common_1.computeLocationSpan)(key, sepEnd, maybeCondition),
    };
});
...
exports.OBJECT_LITERAL_ASSIGNMENT = ASSIGNMENT_FACTORY(new features_1.SyntaxRuleFeatureOr(rule_1.SyntaxRule.operator('=').forgetFollowedBy(RHS_EXPRESSION_FACTORY(exports.INLINE_CALL.or(common_2.PRIMITIVE_LITERAL), '\n', ',', '}')), 'nested_object_literals', (0, common_1.expectTerminated)(OBJECT_LITERAL_MUT, '\n', ',', '}')));
exports.OBJECT_LITERAL = rule_1.SyntaxRule.followedBy(rule_1.SyntaxRule.separator('{'), rule_1.SyntaxRule.optionalRepeat(exports.OBJECT_LITERAL_ASSIGNMENT), rule_1.SyntaxRule.separator('}')).map(function (_a) {
...
exports.SET_BLOCK_ASSIGNMENT = ASSIGNMENT_FACTORY(new features_1.SyntaxRuleFeatureOr(rule_1.SyntaxRule.operator('=').forgetFollowedBy(RHS_EXPRESSION_FACTORY(exports.INLINE_CALL.or(common_2.PRIMITIVE_LITERAL), '\n', ';', '}')), 'nested_object_literals', (0, common_1.expectTerminated)(exports.OBJECT_LITERAL, '\n', ';', '}')));
// SET STATEMENTS //
/**
 * set <?condition> { <...assignment> }
 */
var SET_STATEMENT_FULL = rule_1.SyntaxRule.followedBy(rule_1.SyntaxRule.identifier('set'), rule_1.SyntaxRule.optional(common_2.CONDITION_ATOM), rule_1.SyntaxRule.separator('{'), rule_1.SyntaxRule.repeat(exports.SET_BLOCK_ASSIGNMENT), rule_1.SyntaxRule.separator('}')).map(function (_a) {
...
function CALL_STATEMENT_FACTORY(substatementRule) {
    return rule_1.SyntaxRule.followedBy(CALL_STATEMENT_HEAD, rule_1.SyntaxRule.separator('{'), rule_1.SyntaxRule.optionalRepeat(exports.SET_STATEMENT.or(substatementRule)), rule_1.SyntaxRule.separator('}')).map(function (_a) {
        var _b = __read(_a, 4), head = _b[0], _sepStart = _b[1], statements = _b[2], sepEnd = _b[3];
        return __assign(__assign({ kind: 'CallStatement' }, head), { statements: statements !== null && statements !== void 0 ? statements : [], location: (0, common_1.computeLocationSpan)(head, sepEnd) });
    });
}
...
var HTTP_CALL_STATEMENT_SECURITY_REQUIREMENT = rule_1.SyntaxRule.identifier('security')
    ...
    return {
        id: idString,
        location: (0, common_1.computeLocationSpan)(keyword, id),
    };
});
var HTTP_CALL_STATEMENT_SECURITY_REQUIREMENTS = new features_1.SyntaxRuleFeatureSubstitute(HTTP_CALL_STATEMENT_SECURITY_REQUIREMENT.map(function (s) { return [s]; }), 'multiple_security_schemes', rule_1.SyntaxRule.repeat(HTTP_CALL_STATEMENT_SECURITY_REQUIREMENT)).map(function (arr) {
    ...
    return {
        ...
        location: common_1.computeLocationSpan.apply(void 0, __spreadArray([], __read(arr), false)),
    };
});
var HTTP_CALL_STATEMENT_REQUEST_SLOT_LITERAL = rule_1.SyntaxRule.sameLine(exports.OBJECT_LITERAL).lookahead((0, common_1.TERMINATOR_TOKEN_FACTORY)('\n', '}'));
...
exports.HTTP_REQUEST_VARIABLES_BLOCK = rule_1.SyntaxRule.followedBy(rule_1.SyntaxRule.separator('{'), rule_1.SyntaxRule.optional(HTTP_CALL_STATEMENT_REQUEST_QUERY_SLOT), rule_1.SyntaxRule.optional(HTTP_CALL_STATEMENT_REQUEST_HEADERS_SLOT), rule_1.SyntaxRule.optional(HTTP_CALL_STATEMENT_REQUEST_BODY_SLOT), rule_1.SyntaxRule.separator('}')).map(function (_a) {
...
exports.HTTP_REQUEST_VARIABLES_SHORTHAND = new rule_1.SyntaxRuleOr(HTTP_CALL_STATEMENT_REQUEST_QUERY_SLOT.map(function (_a) {
...
exports.HTTP_CALL_STATEMENT_REQUEST = rule_1.SyntaxRule.followedBy(rule_1.SyntaxRule.identifier('request'), common_2.MAYBE_CONTENT_TYPE, rule_1.SyntaxRule.optional(rule_1.SyntaxRule.string()), // content language
new features_1.SyntaxRuleFeatureOr(exports.HTTP_REQUEST_VARIABLES_BLOCK, 'shorthand_http_request_slots', exports.HTTP_REQUEST_VARIABLES_SHORTHAND)).map(function (_a) {
    ...
    return {
        ...
        location: (0, common_1.computeLocationSpan)(keyword, variablesBlock),
    };
});
var HTTP_REQUEST_OPTIONAL = rule_1.SyntaxRule.optional(HTTP_CALL_STATEMENT_SECURITY_REQUIREMENTS)
    ...
    if (maybeSecurity !== undefined && maybeRequest !== undefined) {
        return __assign(__assign(__assign({ kind: 'HttpRequest' }, maybeRequest), maybeSecurity), { location: (0, common_1.computeLocationSpan)(maybeSecurity, maybeRequest) });
    }
...
function HTTP_CALL_STATEMENT_RESPONSE_HANDLER(substatementRule) {
    return rule_1.SyntaxRule.followedBy(rule_1.SyntaxRule.identifier('response'), rule_1.SyntaxRule.optional(rule_1.SyntaxRule.literal().andThen(function (match) {
        return typeof match.data.literal === 'number'
            ? { kind: 'match', value: match.data.literal }
            : { kind: 'nomatch' };
    }, 'number literal')), common_2.MAYBE_CONTENT_TYPE, rule_1.SyntaxRule.optional(rule_1.SyntaxRule.string()), // content language
    rule_1.SyntaxRule.separator('{'), rule_1.SyntaxRule.optionalRepeat(exports.SET_STATEMENT.or(substatementRule)), rule_1.SyntaxRule.separator('}')).map(function (_a) {
...
var HTTP_CALL_STATEMENT_HEAD = rule_1.SyntaxRule.followedBy(rule_1.SyntaxRule.identifier(), // verb
// service
rule_1.SyntaxRule.optional(rule_1.SyntaxRule.or(rule_1.SyntaxRule.identifier('default'), rule_1.SyntaxRule.string().lookahead(rule_1.SyntaxRule.string()))), 
// url
rule_1.SyntaxRule.string()).map(function (_a) {
    var _b = __read(_a, 3), verb = _b[0], maybeService = _b[1], url = _b[2];
    // if service is `default` then treat it as undefined
    var serviceId = (maybeService === null || maybeService === void 0 ? void 0 : maybeService.data.kind) === 4 /* STRING */
    ...
    return {
        ...
        serviceId: serviceId,
        url: url.data.string,
        location: (0, common_1.computeLocationSpan)(verb, maybeService, url),
    };
});
function HTTP_CALL_STATEMENT_FACTORY(substatementRule) {
    return rule_1.SyntaxRule.followedBy(rule_1.SyntaxRule.identifier('http'), HTTP_CALL_STATEMENT_HEAD, rule_1.SyntaxRule.separator('{'), HTTP_REQUEST_OPTIONAL, rule_1.SyntaxRule.optionalRepeat(HTTP_CALL_STATEMENT_RESPONSE_HANDLER(substatementRule)), rule_1.SyntaxRule.separator('}')).map(function (_a) {
        var _b = __read(_a, 6), keyword = _b[0], head = _b[1], _sepStart = _b[2], maybeRequest = _b[3], maybeResponseHandlers = _b[4], sepEnd = _b[5];
        return {
 ...
 */
exports.MAP_OUTCOME_STATEMENT = rule_1.SyntaxRule.followedBy(rule_1.SyntaxRule.optional(rule_1.SyntaxRule.identifier('return')), rule_1.SyntaxRule.identifier('map'), rule_1.SyntaxRule.identifier('result').or(rule_1.SyntaxRule.identifier('error')), rule_1.SyntaxRule.optional(common_2.CONDITION_ATOM), OUTCOME_VALUE).map(function (_a) {
    ...
    return {
        ...
        condition: maybeCondition,
        value: value,
        location: (0, common_1.computeLocationSpan)(maybeReturn, keywordMap, value),
    };
});
/**
 * return/fail <?condition> <value>;
 */
exports.OPERATION_OUTCOME_STATEMENT = rule_1.SyntaxRule.followedBy(rule_1.SyntaxRule.or(rule_1.SyntaxRule.identifier('return'), rule_1.SyntaxRule.identifier('fail')), rule_1.SyntaxRule.optional(common_2.CONDITION_ATOM), OUTCOME_VALUE).map(function (_a) {
    ...
    return {
        ...
        condition: maybeCondition,
        value: value,
        location: (0, common_1.computeLocationSpan)(keywordType, value),
    };
});
...
// MAP DEFINITION //
exports.MAP_DEFINITION = (0, common_1.documentedNode)(rule_1.SyntaxRule.followedBy(rule_1.SyntaxRule.identifier('map'), rule_1.SyntaxRule.identifier(), rule_1.SyntaxRule.separator('{'), rule_1.SyntaxRule.optionalRepeat(exports.MAP_SUBSTATEMENT), rule_1.SyntaxRule.separator('}')).map(function (_a) {
...
exports.OPERATION_DEFINITION = (0, common_1.documentedNode)(rule_1.SyntaxRule.followedBy(rule_1.SyntaxRule.identifier('operation'), rule_1.SyntaxRule.identifier(), rule_1.SyntaxRule.separator('{'), rule_1.SyntaxRule.optionalRepeat(exports.OPERATION_SUBSTATEMENT), rule_1.SyntaxRule.separator('}')).map(function (_a) {
    var _b = __read(_a, 5), keyword = _b[0], name = _b[1], _sepStart = _b[2], maybeStatements = _b[3], sepEnd = _b[4];
    return {
...
exports.MAP_DOCUMENT = rule_1.SyntaxRule.followedBy(rule_1.SyntaxRule.separator('SOF'), common_2.MAP_HEADER, rule_1.SyntaxRule.optionalRepeat(exports.MAP_DOCUMENT_DEFINITION), rule_1.SyntaxRule.separator('EOF'), new common_1.SyntaxRuleSourceChecksum()).map(function (_a) {
