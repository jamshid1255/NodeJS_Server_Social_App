 ...
 */
export declare type DocumentedStructureType = PrimitiveStructure | EnumStructure | ObjectStructure | ScalarStructure;
/**
 * @type StructureType - represents all structures
 */
export declare type StructureType = DocumentedStructureType | NonNullStructure | ListStructure | UnionStructure;
/**
...
export declare type ObjectCollection = Record<string, StructureType>;
export declare type ArrayCollection = Exclude<StructureType, UnionStructure>[];
export declare function assertDefinedStructure(structure: StructureType | undefined): asserts structure is StructureType;
