...
var debug = (0, debug_1.default)('superface-parser:profile-io-analyzer');
...
var ProfileIOAnalyzer = /** @class */ (function () {
    ...
    ProfileIOAnalyzer.prototype.visitEnumDefinitionNode = function (node) {
        ...
        return {
            ...
            enums: node.values.map(function (value) {
                return addDoc(value, { name: value.name, value: _this.visit(value) });
            }),
        };
    };
    ...
    ProfileIOAnalyzer.prototype.visitNonNullDefinitionNode = function (node) {
        ...
        if ((0, profile_output_utils_1.isUnionStructure)(value)) {
    ...
    ProfileIOAnalyzer.prototype.visitUnionDefinitionNode = function (node) {
        ...
        node.types.forEach(function (type, i) {
            ...
            if (!(0, profile_output_utils_1.isUnionStructure)(structure)) {
    ...
    ProfileIOAnalyzer.prototype.visitUseCaseExampleNode = function (_node) {
        throw new Error('Not Implemented');
    };
    ProfileIOAnalyzer.prototype.visitComlinkPrimitiveLiteralNode = function (_node) {
        throw new Error('Not Implemented');
    };
    ProfileIOAnalyzer.prototype.visitComlinkListLiteralNode = function (_node) {
        throw new Error('Not Implemented');
    };
    ProfileIOAnalyzer.prototype.visitComlinkObjectLiteralNode = function (_node) {
        throw new Error('Not Implemented');
    };
    ProfileIOAnalyzer.prototype.visitComlinkAssignmentNode = function (_node) {
        throw new Error('Not Implemented');
    };
    /**
