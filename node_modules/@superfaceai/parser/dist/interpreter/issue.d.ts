import { ComlinkLiteralNode, ComlinkObjectLiteralNode, LiteralNode, LocationSpan, ObjectLiteralNode } from '@superfaceai/ast';
import { NonNullStructure, ObjectStructure, StructureType, VersionStructure } from './profile-output';
export declare type ValidationIssueKind = 'wrongScope' | 'wrongProfileName' | 'wrongProfileVersion' | 'mapNotFound' | 'extraMapsFound' | 'outcomeNotDefined' | 'useCaseSlotNotFound' | 'wrongStructure' | 'wrongInput' | 'wrongObjectStructure' | 'missingRequired' | 'wrongVariableStructure';
export declare type IssueLocation = {
    kind: string;
...
export declare enum UseCaseSlotType {
    INPUT = "Input",
    RESULT = "Result",
...
export declare type ValidationIssue = WrongScopeIssue | WrongProfileNameIssue | WrongProfileVersionIssue | MapNotFoundIssue | ExtraMapsFoundIssue | OutcomeNotDefinedIssue | UseCaseSlotNotFoundIssue | WrongObjectStructureIssue | WrongStructureIssue | MissingRequiredIssue | WrongInputIssue | WrongVariableStructureIssue;
